...
HD_PWD='E:/CS202ComputerOrganization/lab9/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m_inst.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m_inst.tcl
